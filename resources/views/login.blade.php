...
<body>
    <div class="cont">
        <div class="form sign-in">
            <h2 class="alert alert-danger" role="alert">Sugeng Rawuh</h2>
            ...
            @if (session('message'))
            <div class="alert alert-success"> <b>Yess!</b>
                {{session('message')}}
            </div>
            @endif
            <form action="{{ route('actionlogin') }}" method="post">
                @csrf
                <label>
                    <span style="color: #212529">Email</span>
                    <input type="email" name="email">
                </label>
                <label>
                    <span style="color: #212529">Password</span>
                    <input type="password" name="password">
                </label>
                <p class="forgot-pass"><a href="#">Forgot Paswsword?</a></p>
        ...
        <div class="sub-cont">
            ...
            <form action="{{ route('actionregister') }}" method="POST" class="form sign-up">
                @csrf
